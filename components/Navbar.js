...
const Navbar = () => {
    ...
    return (
        <nav className='bg-gradient-to-r from-[#00092d] text-white flex sm:flex-row flex-col sm:justify-between justify-between items-center sm:px-4 sm:h-14 md:px-4 px-0 md:h-16 h-24 py-4'>
            <div className="logo font-bold text-2xl md:text-3xl"><Link href="/"> GetMeAChai</Link> </div>
            ...
            <div className='relative py-2 flex '>
                {session && <>
                    ...
                    }} id="dropdownHoverButton" data-dropdown-toggle="dropdown" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-2 py-1.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
                        Welcome
                        <span className='ml-2'>
                            <img width={28} className='block sm:hidden ml-2' src="/Profile.svg" alt="Profile Photo" />
